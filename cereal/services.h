...
static std::map<std::string, service> services = {
  ...
  { "roadEncodeData", {"roadEncodeData", true, 20, -1}},
  { "driverEncodeData", {"driverEncodeData", true, 20, -1}},
  { "wideRoadEncodeData", {"wideRoadEncodeData", true, 20, -1}},
  { "qRoadEncodeData", {"qRoadEncodeData", true, 20, -1}},
  { "livestreamWideRoadEncodeIdx", {"livestreamWideRoadEncodeIdx", true, 20, -1}},
  { "livestreamRoadEncodeIdx", {"livestreamRoadEncodeIdx", true, 20, -1}},
  { "livestreamDriverEncodeIdx", {"livestreamDriverEncodeIdx", true, 20, -1}},
  { "livestreamWideRoadEncodeData", {"livestreamWideRoadEncodeData", true, 20, -1}},
  { "livestreamRoadEncodeData", {"livestreamRoadEncodeData", true, 20, -1}},
  { "livestreamDriverEncodeData", {"livestreamDriverEncodeData", true, 20, -1}},
